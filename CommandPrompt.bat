...
@doskey webw=dotnet watch run -p Infrastructure\Host\Web\MvcForms.Infrastructure.Host.Web.csproj $*
@doskey web=dotnet run -p Infrastructure\Host\Web\MvcForms.Infrastructure.Host.Web.csproj $*
